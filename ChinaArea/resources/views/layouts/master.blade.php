...
<html lang="{{ App::getLocale() }}">
    <head>
        ...
        <meta name="author" content="ChinaArea" />
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="_token" content="{{ csrf_token() }}">
        <title>ChinaArea</title>
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap/dist/css/bootstrap.min.css">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.min.css">
        <link rel="stylesheet" href="{{ plugin_assets('ChinaArea/css/fresns.css') }}">
    ...
    <body>
        <header>
            @include('ChinaArea::layouts.header')
        </header>
        ...
        <footer>
            @include('ChinaArea::layouts.footer')
        </footer>

        <!-- Tips -->
        <div class="fresns-tips">
            @include('ChinaArea::layouts.tips')
        </div>
        ...
        <link rel="stylesheet" href="{{ plugin_assets('ChinaArea/js/fresns.js') }}">
        <script>
            /* Tooltips */
