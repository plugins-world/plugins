...
<div class="flex h-full" x-data="{
  ...
  <div class="relative z-40 lg:hidden" role="dialog" aria-modal="true" x-show="sidebarOpen">
    <!--
    ...
    <div class="fixed inset-0 z-40 flex">
      ...
      >
        ...
        <div class="hidden flex flex-shrink-0 border-t border-gray-200 p-4">
  ...
  <div class="flex min-w-0 flex-1 flex-col overflow-hidden">
    <div class="lg:hidden">
      <div class="flex items-center justify-between border-b border-gray-200 bg-gray-50 px-4 py-1.5">
        ...
        <div>
          <button @click="sidebarOpen=true" type="button" class="-mr-3 inline-flex h-12 w-12 items-center justify-center rounded-md text-gray-500 hover:text-gray-900">
    ...
    <div class="relative z-0 flex flex-1 overflow-hidden">
      <main class="relative z-0 flex-1 overflow-y-auto focus:outline-none xl:order-last">
        <!-- Start main area-->
        <div class="content inset-0 py-6 px-4 sm:px-6 lg:px-8">
