...
<html lang="{{ App::getLocale() }}">
    <head>
        ...
        <meta name="author" content="EasySms" />
    ...
    <body>
        <header>
            <!-- @include('EasySms::layouts.header') -->
        </header>
        ...
        <footer>
            @include('EasySms::layouts.footer')
        </footer>

        <!-- Tips -->
        <div class="fresns-tips">
            @include('EasySms::layouts.tips')
        </div>
                ...
                let html = `<div aria-live="polite" aria-atomic="true" class="position-fixed top-50 start-50 translate-middle" style="z-index:99">
                    <div class="toast show" role="alert" aria-live="assertive" aria-atomic="true">
                        <div class="toast-header">
                            <!--<img src="/static/images/icon.png" width="20px" height="20px" class="rounded me-2" alt="PluginsWorld"> -->
                                <strong class="me-auto">PluginsWorld</strong>
                                <small>${code}</small>
