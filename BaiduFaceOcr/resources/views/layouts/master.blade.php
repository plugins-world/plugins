...
<html lang="{{ App::getLocale() }}">
    <head>
        ...
        <meta name="author" content="BaiduFaceOcr" />
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="_token" content="{{ csrf_token() }}">
        <title>BaiduFaceOcr</title>
    ...
    <body>
        <header>
            <!--@include('BaiduFaceOcr::layouts.header')-->
        </header>
        ...
        <footer>
            @include('BaiduFaceOcr::layouts.footer')
        </footer>

        <!-- Tips -->
        <div class="fresns-tips">
            @include('BaiduFaceOcr::layouts.tips')
        </div>
