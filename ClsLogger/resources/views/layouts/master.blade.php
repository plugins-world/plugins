...
<html lang="{{ App::getLocale() }}">
    <head>
        ...
        <meta name="author" content="ClsLogger" />
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="_token" content="{{ csrf_token() }}">
        <title>ClsLogger</title>
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap/dist/css/bootstrap.min.css">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.min.css">
        <link rel="stylesheet" href="{{ plugin_assets('ClsLogger/css/fresns.css') }}">
    ...
    <body>
        <header>
            @include('ClsLogger::layouts.header')
        </header>
        ...
        <footer>
            @include('ClsLogger::layouts.footer')
        </footer>

        <!-- Tips -->
        <div class="fresns-tips">
            @include('ClsLogger::layouts.tips')
        </div>
        ...
        <link rel="stylesheet" href="{{ plugin_assets('ClsLogger/js/fresns.js') }}">
        <script>
            /* Tooltips */
