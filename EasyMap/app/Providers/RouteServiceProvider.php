...
class RouteServiceProvider extends BaseServiceProvider
{
    ...
    {
        Route::prefix('easy-map')->name('easy-map.')->middleware('web')->group(dirname(__DIR__, 2) . '/routes/web.php');
    }
    ...
    {
        Route::prefix('api/easy-map')->name('easy-map.')->middleware('api')->group(dirname(__DIR__, 2) . '/routes/api.php');
    }
}
